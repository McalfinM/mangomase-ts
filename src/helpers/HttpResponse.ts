...
class HttpResponse {
    ...
    unauthenticated(req: Request, res: Response, data?: any): Response {
        return res.status(403).jsonp(data)
    }

    unauthorized(req: Request, res: Response, data?: any): Response {
        return res.status(401).jsonp(data)
    }
